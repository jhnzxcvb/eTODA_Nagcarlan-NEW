  ...
  void _updateMarkers() {
    setState(() {
      _markers = _dynamicStations.map((station) {
        ...
        final Color dbColor = dbColorHex.isNotEmpty ? _parseHexColor(dbColorHex) : nagcarlanGreen;
                ...
                children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isHighlighted ? nagcarlanYellow : Colors.white,
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          color: isHighlighted ? nagcarlanGreen : baseColor
                      ),
                  ...
                  Stack(
                    ...
                    children: [
                      Icon(
                        ...
                        color: isHighlighted ? nagcarlanYellow : baseColor,
                      ),
                      Positioned(
                    ...
                    child: activeStationFilter != null
                        ? Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: nagcarlanGreen.withValues(alpha: 0.05),
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(color: nagcarlanGreen.withValues(alpha: 0.1)),
                              ),
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: const Icon(Icons.filter_alt_rounded, size: 18, color: nagcarlanGreen),
                                  ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        const Text(
                                          ...
                                          style: TextStyle(color: nagcarlanGreen, fontSize: 11, fontWeight: FontWeight.bold),
                                        ),
                                        Text(
                                          activeStationFilter!,
                                  ...
                                  IconButton(
                                    icon: const Icon(Icons.cancel_rounded, color: nagcarlanGreen),
      ...
      fieldViewBuilder: (ctx, ctrl, node, onSubmit) {
        ...
        return TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: nagcarlanGreen, width: 2)),
            filled: true,
            fillColor: Colors.white,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [nagcarlanGreen, Color(0xFF1E6F3D)],
      ...
      child: Column(
        children: [
          const Row(
            ...
            children: [
              Icon(Icons.payments_rounded, color: nagcarlanYellow, size: 16),
              SizedBox(width: 8),
              Text("TOTAL ESTIMATED FARE", style: TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
            ],
          ),
          const SizedBox(height: 8),
          Text(fare, style: const TextStyle(color: nagcarlanYellow, fontSize: 48, fontWeight: FontWeight.w900, letterSpacing: -1)),
              ...
              if (tripType == "Special Trip")
                Padding(
                  ...
                  child: Container(
                    ...
                    child: const Text(
                      "Special Trip",
                      style: TextStyle(color: nagcarlanYellow, fontSize: 12, fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
              if (discountAmount > 0)
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(color: nagcarlanYellow, fontSize: 12, fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
            ],
