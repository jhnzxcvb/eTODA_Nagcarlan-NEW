...
Future<void> testConnection() async {
  try {
    final response = await http.get(Uri.parse('${ApiService.baseUrl}/api/drivers'));
...
void main() {
  ...
  // you can override the URL at runtime here if needed;
  // e.g. set to a LAN IP when running on a physical device:
  // ApiService.setBaseUrl('http://192.168.1.42:8080');
